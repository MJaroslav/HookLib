...
Отличия форка
------------
Добавлен скрипт сборщика, чтобы библиотеку можно было подключать через JitPack.

Удалены бинарники маппингов.

Все выводы обёрнуты в логгер и добавлен менеджер логирования.

Очистка и реформатирование кода (машинные).
